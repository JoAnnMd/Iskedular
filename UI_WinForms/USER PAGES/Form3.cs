...
                Reservation newReservation = new Reservation

                {
                    ...
                    EndTime = endDateTime,
                    Purpose = textBox11.Text.Trim(),          // Still the actual purpose
...
                await _reservationService.AddReservationAsync(newReservation);
                ...
                //MessageBox.Show($"Reservation request submitted for {selectedRoomName} on {selectedDate.ToShortDateString()} from {startTimeSpan:hh\\:mm} to {endTimeSpan:hh\\:mm}.", "Reservation Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
