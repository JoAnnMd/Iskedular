...
namespace Iskedular.Models // Make sure this namespace matches your project setup
{
    public class Room
    {
        ...
        public bool HasTV { get; set; } // <-- ADDED THIS PROPERTY
        public bool IsComputerLab { get; set; } // <-- ADDED THIS PROPERTY
        public bool HasAirConditioning { get; set; } // <-- ADDED THIS PROPERTY
