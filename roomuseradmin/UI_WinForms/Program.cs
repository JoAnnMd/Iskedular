...
using Iskedular.Core.Services;   // UserService, ReservationService, AnnouncementService, and SessionService were referenced
...
namespace UI_WinForms
{
    static class Program
    {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            // Changed UserService to use its interface, IUserService
            services.AddTransient<IUserService, UserService>();
            // NEW: Register ReservationService
            services.AddTransient<IReservationService, ReservationService>();
            // NEW: Register AnnouncementService
            services.AddTransient<IAnnouncementService, AnnouncementService>();
            // NEW: Register RoomService
            services.AddTransient<IRoomService, RoomService>(); // <-- ADD THIS LINE
            ...
            services.AddTransient<Form6>(); // Password Change (User/Admin) (assuming Form6 exists)
            ...
            services.AddTransient<Form13>(); // Admin Rooms
