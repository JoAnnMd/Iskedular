...
namespace UI_WinForms
{
    public partial class Available_Rooms : Form
    {
        ...
        public Available_Rooms(IServiceProvider serviceProvider)
        {
            InitializeComponent();
        ...
        {
            // Logic for textBox15_TextChanged is here.
        }

        // The button6_Click event was configured to navigate to Form10.
        private void button6_Click(object sender, EventArgs e)
        {
            Form10 form10 = _serviceProvider.GetRequiredService<Form10>(); // The form was retrieved from DI.
            form10.Show();
            this.Hide();
        }
