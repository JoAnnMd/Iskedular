...
namespace Iskedular.Core.Services
{
    public class UserService
    {
        ...
        public async Task<User?> RegisterUserAsync(string firstName, string lastName, string email, string plainTextPassword, string programSection) // Updated method signature to include programSection
        {
            ...
            using (var context = _dbContextFactory.CreateDbContext())
            {
                ...
                var newUser = new User
                {
                    ...
                    LastName = lastName,
                    Email = email,
                    ProgramSection = programSection // Added programSection property
                };
